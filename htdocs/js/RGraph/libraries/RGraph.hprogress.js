    ...
    */
    RGraph.HProgress.prototype.Drawbar = function ()
    {
        ...
        if (this.Get('chart.tickmarks.inner')) {
            ...
            var spacing = (RGraph.GetWidth(this) - this.Get('chart.gutter') - this.Get('chart.gutter')) / this.Get('chart.numticks.inner');

            this.context.lineWidth   = 1;
            this.context.strokeStyle = '#999';

            this.context.beginPath();
            for (var x = this.Get('chart.gutter'); x<RGraph.GetWidth(this) - this.Get('chart.gutter'); x+=spacing) {
                this.context.moveTo(x, this.Get('chart.gutter'));
                this.context.lineTo(x, this.Get('chart.gutter') + 2);

                this.context.moveTo(x, RGraph.GetHeight(this) - this.Get('chart.gutter'));
                this.context.lineTo(x, RGraph.GetHeight(this) - this.Get('chart.gutter') - 2);
            }
            this.context.stroke();
        }
        ...
        if (this.Get('chart.arrows')) {
            ...
            */
            if (this.Get('chart.label.inner')) {
                this.context.beginPath();
                this.context.fillStyle = 'black';
                RGraph.Text(this.context, this.Get('chart.text.font'), this.Get('chart.text.size') + 2, this.Get('chart.gutter') + barWidth + 5, RGraph.GetHeight(this) / 2, String(this.Get('chart.units.pre') + this.value + this.Get('chart.units.post')), 'center', 'left');
                this.context.fill();
            }
        }
    ...
    RGraph.HProgress.prototype.DrawTickMarks = function ()
    {
        ...
        if (this.Get('chart.tickmarks')) {
            ...
            if (this.Get('chart.labels.position') == 'top') {
                for (var i=gutter + start; i<=(this.width + gutter); i+=this.tickInterval) {
    ...
    RGraph.HProgress.prototype.DrawLabels = function ()
    {
        ...
        if (this.Get('chart.labels.position') == 'top') {
            ...
            if (this.Get('chart.tickmarks.zerostart')) {
                RGraph.Text(this.context,font,size,this.Get('chart.gutter'),this.Get('chart.gutter') - 4 - 2,this.Get('chart.units.pre') + Number(this.Get('chart.min')).toFixed(this.Get('chart.scale.decimals')) + this.Get('chart.units.post'),'bottom','center');
            }
            ...
            if (this.Get('chart.tickmarks.zerostart')) {
                RGraph.Text(this.context,font,size,this.Get('chart.gutter'),RGraph.GetHeight(this) - this.Get('chart.gutter') + 4,this.Get('chart.units.pre') + Number(this.Get('chart.min')).toFixed(this.Get('chart.scale.decimals')) + this.Get('chart.units.post'),'top','center');
            }
        }
