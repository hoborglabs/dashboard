    ...
    */
    RGraph.Rose.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.radius       = (Math.min(RGraph.GetWidth(this), RGraph.GetHeight(this)) / 2);
            ...
            var canvas_onclick_func = function (e)
            {
                ...
                if (segment && obj.Get('chart.tooltips')[segment[5]]) {
                    context.beginPath();
                        ...
                        context.arc(obj.centerx, obj.centery, segment[2], segment[3] / 57.3, segment[4] / 57.3, false);
