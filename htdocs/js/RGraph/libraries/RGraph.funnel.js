    ...
    */
    RGraph.Funnel.prototype.DrawFunnel = function ()
    {
        ...
        var width     = RGraph.GetWidth(this) - (2 * this.Get('chart.gutter'));
        var height    = RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'));
        ...
        */
        ...
        for (i=0; i<this.data.length; ++i) {
            ...
            var center    = (RGraph.GetWidth(this) / 2);
        ...
        */
        if (this.Get('chart.labels') && this.Get('chart.labels').length > 0) {
            ...
            for (var j=0; j<this.coords.length; ++j) {  // MUST be "j"
                ...
                RGraph.Text(context, this.Get('chart.text.font'), this.Get('chart.text.size'), this.Get('chart.text.halign') == 'left' ? 15 : RGraph.GetWidth(this) / 2, this.coords[j][1], label, 'center', this.Get('chart.text.halign') == 'left' ? 'left' : 'center', true, null, this.Get('chart.text.boxed') ? 'white' : null);
            }
        }
    }
