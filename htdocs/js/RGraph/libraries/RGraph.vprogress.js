    ...
    */
    RGraph.VProgress.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.width  = RGraph.GetWidth(this) - (2 * this.Get('chart.gutter'));
        this.height = RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'));
        this.coords = [];
    ...
    */
    RGraph.VProgress.prototype.Drawbar = function ()
    {
        ...
        var barHeight = RGraph.GetHeight(this) - this.Get('chart.gutter') - this.Get('chart.gutter');
        ...
        if (typeof(this.value) == 'number') {
            ...
            var startPoint = RGraph.GetHeight(this) - this.Get('chart.gutter');
        ...
        */
        if (this.Get('chart.tickmarks.inner')) {
            ...
            var spacing = (RGraph.GetHeight(this) - this.Get('chart.gutter') - this.Get('chart.gutter')) / this.Get('chart.numticks.inner');
            ...
            for (var y = this.Get('chart.gutter'); y<RGraph.GetHeight(this) - this.Get('chart.gutter'); y+=spacing) {
                this.context.moveTo(this.Get('chart.gutter'), y);
                this.context.lineTo(this.Get('chart.gutter') + 3, y);

                this.context.moveTo(RGraph.GetWidth(this) - this.Get('chart.gutter'), y);
                this.context.lineTo(RGraph.GetWidth(this) - this.Get('chart.gutter') - 3, y);
            }
        ...
        */
        if (this.Get('chart.arrows')) {
            ...
            var y = RGraph.GetHeight(this) - this.Get('chart.gutter') - barHeight;
        ...
        */
        if (this.Get('chart.label.inner')) {
            this.context.beginPath();
            this.context.fillStyle = 'black';
            RGraph.Text(this.context, this.Get('chart.text.font'), this.Get('chart.text.size') + 2, RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) - this.Get('chart.gutter') - barHeight - 5, String(this.Get('chart.units.pre') + this.value + this.Get('chart.units.post')), 'bottom', 'center');
            this.context.fill();
        }
    ...
    */
    RGraph.VProgress.prototype.DrawTickMarks = function ()
    {
        ...
        if (this.Get('chart.tickmarks')) {
            ...
            var startX = this.Get('chart.labels.position') == 'left' ? (gutter - 4) : (RGraph.GetWidth(this) - gutter);
            var endX   = this.Get('chart.labels.position') == 'left' ? gutter : RGraph.GetWidth(this) - gutter + 4;

            this.tickInterval = this.height / this.Get('chart.numticks');
            
            var endY = this.Get('chart.tickmarks.zerostart') ? (RGraph.GetHeight(this) - gutter) : (RGraph.GetHeight(this) - gutter - this.tickInterval);

            this.context.beginPath();
                for (var i=gutter; i<=endY; i+=this.tickInterval) {
    ...
    RGraph.VProgress.prototype.DrawLabels = function ()
    {
        ...
        if (this.Get('chart.tickmarks')) {
            for (var i=0; i<count ; ++i) {
                ...
                RGraph.Text(context, text_font, text_size, position == 'left' ? (gutter - 5) : (RGraph.GetWidth(this) - gutter + 5), (((RGraph.GetHeight(this) - (2 * gutter)) / count) * i) + gutter, units_pre + text + units_post, yAlignment, xAlignment);
            }
            ...
            */            
            if (this.Get('chart.tickmarks.zerostart') && this.Get('chart.min') == 0) {
                RGraph.Text(context, text_font, text_size, position == 'left' ? (gutter - 5) : (RGraph.GetWidth(this) - gutter + 5), RGraph.GetHeight(this) - gutter, units_pre + String(this.Get('chart.min').toFixed(this.Get('chart.scale.decimals'))) + units_post, yAlignment, xAlignment);
            }
