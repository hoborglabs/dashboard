    ...
    */
    RGraph.Scatter.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.grapharea = RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'));
    ...
    */
    RGraph.Scatter.prototype.DrawAxes = function ()
    {
        ...
        var graphHeight = RGraph.GetHeight(this) - (this.Get('chart.gutter') * 2);
        ...
        if (this.Get('chart.yaxispos') == 'left') {
            ...
            context.lineTo(gutter, RGraph.GetHeight(this) - gutter);
        } else {
            context.moveTo(RGraph.GetWidth(this) - gutter, gutter);
            context.lineTo(RGraph.GetWidth(this) - gutter, RGraph.GetHeight(this) - gutter);
        }
        ...
        if (this.Get('chart.xaxis')) {
            if (this.Get('chart.xaxispos') == 'center') {
                context.moveTo(gutter, RGraph.GetHeight(this) / 2);
                context.lineTo(RGraph.GetWidth(this) - gutter, RGraph.GetHeight(this) / 2);
            } else {
                context.moveTo(gutter, RGraph.GetHeight(this) - gutter);
                context.lineTo(RGraph.GetWidth(this) - gutter, RGraph.GetHeight(this) - gutter);
            }
        }
        ...
        */
        for (y=gutter; y < RGraph.GetHeight(this) - gutter + (this.Get('chart.xaxispos') == 'center' ? 1 : 0) ; y+=(graphHeight / 5) / 2) {

            // This is here to accomodate the X axis being at the center
            if (y == (RGraph.GetHeight(this) / 2) ) continue;

            if (this.Get('chart.yaxispos') == 'left') {
                context.moveTo(gutter, y);
                context.lineTo(gutter - 3, y);
            } else {
                context.moveTo(RGraph.GetWidth(this) - gutter +3, y);
        ...
        */
        if (this.Get('chart.xticks') && this.Get('chart.xaxis')) {
            ...
            var x  = 0;
            var y  =  (this.Get('chart.xaxispos') == 'center') ? (RGraph.GetHeight(this) / 2) : (RGraph.GetHeight(this) - gutter);
            this.xTickGap = this.Get('chart.labels') && this.Get('chart.labels').length ? ((RGraph.GetWidth(this) - (2 * gutter) ) / this.Get('chart.labels').length) : (RGraph.GetWidth(this) - (2 * gutter)) / 10;

            for (x = (gutter + (this.Get('chart.yaxispos') == 'left' ? this.xTickGap / 2 : 0) ); x<=(RGraph.GetWidth(this) - gutter - (this.Get('chart.yaxispos') == 'left' ? 0 : 1)); x += this.xTickGap / 2) {

                if (this.Get('chart.yaxispos') == 'left' && this.Get('chart.noendxtick') == true && x == (RGraph.GetWidth(this) - gutter) ) {
                    continue;
    ...
    */
    RGraph.Scatter.prototype.DrawLabels = function ()
    {
        ...
        this.halfGraphHeight = (RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'))) / 2;
        ...
        */
            ...
            if (this.Get('chart.xaxispos') == 'center') {
                ...
                */
                ...
                if (numYLabels == 1 || numYLabels == 3 || numYLabels == 5) {
                    ...
                    if (numYLabels >= 5) {
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (1/10) ), RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', align);
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (3/10) ), RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', align);
                    }
        
                    if (numYLabels >= 3) {
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (2/10) ), RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', align);
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (4/10) ), RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', align);
                    }
                    
                    // Draw the bottom halves labels
                    if (numYLabels >= 3) {
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (1/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', align);
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (3/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', align);
                    }
        
                    if (numYLabels == 5) {
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (2/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', align);
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (4/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', align);
                    }
        
                    RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (5/10) ) + this.halfGraphHeight, '-' + RGraph.number_format(this, this.scale[4], units_pre, units_post), 'center', align);
                    ...
                    for (var i=0; i<numYLabels; ++i) {
                        RGraph.Text(context, font, text_size, xPos,gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (i/20) ),RGraph.number_format(this,
                        
                        (this.max - (this.max * (i/10))).toFixed(this.Get('chart.scale.decimals')),
                        
                        units_pre, units_post),'center', align);
                        RGraph.Text(context, font, text_size, xPos,gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (i/20) ) + (this.grapharea / 2) + (this.grapharea / 20),'-' + RGraph.number_format(this, ((this.max * (i/10)) + (this.max * (1/10))).toFixed((this.Get('chart.scale.decimals'))), units_pre, units_post), 'center', align);
                    }
                ...
                */
                ...
                if (numYLabels == 1 || numYLabels == 3 || numYLabels == 5) {
                    if (invert) {
                        RGraph.Text(context, font, text_size, xPos, gutter, RGraph.number_format(this, 0, units_pre, units_post), 'center', align);
                        RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (5/5) ), RGraph.number_format(this, this.scale[4], units_pre, units_post), 'center', align);
        
                        if (numYLabels >= 5) {
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (2/5) ), RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', align);
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (4/5) ), RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', align);
                        }
        
                        if (numYLabels >= 3) {
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (3/5) ), RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', align);
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (1/5) ), RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', align);
                        }
                    } else {
                        RGraph.Text(context, font, text_size, xPos, gutter, RGraph.number_format(this, this.scale[4], units_pre, units_post), 'center', align);
        
                        if (numYLabels >= 5) {
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (1/5) ), RGraph.number_format(this, this.scale[3], units_pre, units_post), 'center', align);
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (3/5) ), RGraph.number_format(this, this.scale[1], units_pre, units_post), 'center', align);
                        }
        
                        if (numYLabels >= 3) {
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (2/5) ), RGraph.number_format(this, this.scale[2], units_pre, units_post), 'center', align);
                            RGraph.Text(context, font, text_size, xPos, gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (4/5) ), RGraph.number_format(this, this.scale[0], units_pre, units_post), 'center', align);
                        }
                    }
                } else if (numYLabels == 10) {
                    var interval = (this.grapharea / numYLabels) / 2;
                    if (invert) {
                        for (var i=numYLabels; i>=0; --i) {
                            RGraph.Text(context, font, text_size, xPos,gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * ((10-i)/10) ),
                        ...
                        // 10 Y labels
                        for (var i=0; i<numYLabels; ++i) {
                            RGraph.Text(context, font, text_size, xPos,gutter + ((RGraph.GetHeight(this) - (2 * gutter)) * (i/10) ),RGraph.number_format(this,(this.max - (this.max * (i/10))).toFixed((this.Get('chart.scale.decimals'))), units_pre, units_post), 'center', align);
                        }
                    }
                } else {
                    alert('[SCATTER SCALE] Number of Y labels can be 1/3/5/10 only');
                ...
                if (this.Get('chart.ymin')) {
                    RGraph.Text(context, font, text_size, xPos, RGraph.GetHeight(this) - gutter,RGraph.number_format(this, this.Get('chart.ymin').toFixed(this.Get('chart.scale.decimals')), units_pre, units_post),'center', align);
                }
            }
        }
        ...
        var graphArea = RGraph.GetWidth(this) - (2 * gutter);
        var xInterval = graphArea / this.Get('chart.labels').length;
        var xPos      = gutter;
        var yPos      = (RGraph.GetHeight(this) - gutter) + 15;
        ...
        for (i=0; i<labels.length; ++i) {
            ...
            if (typeof(labels[i]) == 'object') {
                ...
                RGraph.Text(context,
                            ...
                            gutter + (graphArea * ((labels[i][1] - xMin + offset) / (this.Get('chart.xmax') - xMin))) + 5,
                            yPos,
                            String(labels[i][0]),
                            valign,
                ...
                */
                this.context.beginPath();
                    ...
                    this.context.moveTo(gutter + (graphArea * ((labels[i][1] - xMin)/ (this.Get('chart.xmax') - xMin))), RGraph.GetHeight(this) - gutter);
                    this.context.lineTo(gutter + (graphArea * ((labels[i][1] - xMin)/ (this.Get('chart.xmax') - xMin))), RGraph.GetHeight(this) - gutter + 20);
                this.context.stroke();
        ...
        */
        if (typeof(labels[0]) == 'object') {
            this.context.beginPath();
                this.context.strokeStyle = '#bbb';
                this.context.moveTo(gutter + graphArea, RGraph.GetHeight(this) - gutter);
                this.context.lineTo(gutter + graphArea, RGraph.GetHeight(this) - gutter + 20);
            this.context.stroke();
        }
    }
    ...
    */
    RGraph.Scatter.prototype.DrawMark = function (index, x, y, xMax, yMax, color, tooltip, coords, data)
    {
        ...
        */
        ...
        var gutter    = this.Get('chart.gutter');
        var xMin      = this.Get('chart.xmin');
        var x = ((x - xMin) / (xMax - xMin)) * (RGraph.GetWidth(this) - (2 * gutter));
        var originalX = x;
        var originalY = y;
        ...
        */
        if (   typeof(y) == 'object'
            ...
            */
            ...
            var yMin = this.Get('chart.ymin') ? this.Get('chart.ymin') : 0;
            var y = (( (y - yMin) / (yMax - yMin)) * (RGraph.GetHeight(this) - (2 * gutter)));
        }
        ...
        */
        ...
        x += gutter;
        y = RGraph.GetHeight(this) - gutter - y;
        ...
        */
        if (!y0 && !y1 && !y2 && !y3 && !y4) {
            ...
            */
                ...
                var graphWidth = RGraph.GetWidth(this) - (2 * this.Get('chart.gutter'))
    ...
    */
    RGraph.Scatter.prototype.DrawVBars = function ()
    {
        ...
        var gutter = this.Get('chart.gutter');
        var graphWidth = RGraph.GetWidth(this) - gutter - gutter;
        ...
        if (vbars) {
            ...
            for (var i=0; i<vbars.length; ++i) {
                ...
                context.beginPath();
                    ...
                    context.fillRect(startX, gutter, width, (RGraph.GetHeight(this) - gutter - gutter));
                context.fill();
            }
        }
    }