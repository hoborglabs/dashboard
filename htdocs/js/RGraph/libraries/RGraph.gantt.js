7    /**
    ...
    */
    RGraph.Gantt.prototype.Draw = function ()
    {
        ...
        */
        this.graphArea     = RGraph.GetWidth(this) - (2 * gutter);
    ...
    RGraph.Gantt.prototype.DrawLabels = function ()
    {
        ...
        */
        ...
        for (i=0; i<this.Get('chart.labels').length; ++i) {
            RGraph.Text(this.context, this.Get('chart.text.font'), this.Get('chart.text.size'), xPos + (i * labelSpace), gutter * 0.75, String(this.Get('chart.labels')[i]), 'center', 'center');
        }
    ...
    RGraph.Gantt.prototype.DrawEvents = function ()
    {
        ...
        */
        if (this.Get('chart.vbars')) {
            for (i=0; i<this.Get('chart.vbars').length; ++i) {
                ...
                var height = RGraph.GetHeight(this) - (2 * gutter);
                
                // Right hand bounds checking
                if ( (barX + width) > (RGraph.GetWidth(this) - gutter) ) {
                    width = RGraph.GetWidth(this) - gutter - barX;
                }
        ...
        */
        for (i=0; i<events.length; ++i) {
            ...
            */
            if ( (barStartX + barWidth) > (RGraph.GetWidth(this) - gutter) ) {
                barWidth = RGraph.GetWidth(this) - gutter - barStartX;
            }
