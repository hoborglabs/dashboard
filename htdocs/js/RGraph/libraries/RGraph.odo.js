    ...
    */
    RGraph.Odometer.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.radius   = Math.min(RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2) - this.Get('chart.gutter') - (this.Get('chart.border') ? 25 : 0);
    ...
    */
    RGraph.Odometer.prototype.DrawBackground = function ()
    {
        ...
        */
        ...
        var greengrad = this.canvas.getContext('2d').createRadialGradient(RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2, 0, RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2, RGraph.GetWidth(this) / 2, RGraph.GetWidth(this) / 2);
        ...
        var yellowgrad = this.canvas.getContext('2d').createRadialGradient(RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2, 0, RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2, RGraph.GetWidth(this) / 2, RGraph.GetWidth(this) / 2);
        ...
        var redgrad = this.canvas.getContext('2d').createRadialGradient(RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2, 0, RGraph.GetWidth(this) / 2, RGraph.GetHeight(this) / 2, RGraph.GetWidth(this) / 2, RGraph.GetWidth(this) / 2);
        ...
        */
        if (this.Get('chart.border')) {
            ...
            grad.addColorStop(1, this.Get('chart.border.color1'));
            grad.addColorStop(0.5, this.Get('chart.border.color2'));
            grad.addColorStop(0, this.Get('chart.border.color3'));
            ...
            this.context.beginPath();
                ...
                this.context.arc(this.centerx, this.centery, this.radius + 9, 0, 6.2830, 0);
            this.context.stroke();
        }
        ...
        if (this.Get('chart.needle.type') == 'pointer') {
            ...
            */
            this.context.beginPath();
                ...
                this.context.arc(this.centerx, this.centery, this.radius - this.Get('chart.label.area') - 5, (((value / this.range) * 360) - 90) / 57.3, ((((value / this.range) * 360) - 90) / 57.3) + 0.01, 0);
            this.context.closePath();
            this.context.fill();
            ...
            this.context.beginPath();
                ...
                this.context.arc(this.centerx, this.centery, this.radius - this.Get('chart.label.area') - 13, (((value / this.range) * 360) - 90) / 57.3, ((((value / this.range) * 360) - 90) / 57.3) + 0.01, 0);
            this.context.closePath();
            this.context.stroke();
            this.context.fill();
