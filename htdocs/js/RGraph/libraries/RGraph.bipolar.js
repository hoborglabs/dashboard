    ...
    */
    RGraph.Bipolar.prototype.DrawAxes = function ()
    {
        ...
        this.axisWidth  = (RGraph.GetWidth(this) - this.Get('chart.gutter.center') ) / 2;
        this.axisHeight = RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'));

        this.context.moveTo(this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter'));
        this.context.lineTo(this.axisWidth, RGraph.GetHeight(this) - this.Get('chart.gutter'));
        ...
        this.axisWidth  = ((RGraph.GetWidth(this) - this.Get('chart.gutter.center')) / 2) + this.Get('chart.gutter.center');
        
        this.context.moveTo(this.axisWidth, this.Get('chart.gutter'));
        this.context.lineTo(this.axisWidth, RGraph.GetHeight(this) - this.Get('chart.gutter'));
        this.context.lineTo(RGraph.GetWidth(this) - this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter'));
    ...
    */
    RGraph.Bipolar.prototype.DrawTicks = function ()
    {
        ...
        var barHeight     = ( (RGraph.GetHeight(this) - (2 * this.Get('chart.gutter')))- (this.left.length * (this.Get('chart.margin') * 2) )) / numDataPoints;
        
        // Draw the left Y tick marks
        for (var i = RGraph.GetHeight(this) - this.Get('chart.gutter'); i >= this.Get('chart.gutter'); i -= (barHeight + ( this.Get('chart.margin') * 2)) ) {
            if (i < (RGraph.GetHeight(this) - this.Get('chart.gutter')) ) {
                this.context.beginPath();
        ...
        var xInterval = (RGraph.GetWidth(this) - (2 * this.Get('chart.gutter')) - this.Get('chart.gutter.center')) / 10;
        ...
        for (i=this.Get('chart.gutter'); i<(RGraph.GetWidth(this) - this.Get('chart.gutter.center') ) / 2; i += xInterval) {
            this.context.beginPath();
            this.context.moveTo(i, RGraph.GetHeight(this) - this.Get('chart.gutter'));  // 4 is the tick height
            this.context.lineTo(i, (RGraph.GetHeight(this) - this.Get('chart.gutter')) + 4);
        ...
        var stoppingPoint = (RGraph.GetWidth(this) - (2 * this.Get('chart.gutter')) - this.Get('chart.gutter.center')) / 2;
        var stoppingPoint = stoppingPoint + this.Get('chart.gutter.center') + this.Get('chart.gutter')

        for (i=RGraph.GetWidth(this)  - this.Get('chart.gutter'); i > stoppingPoint; i-=xInterval) {
            this.context.beginPath();
                this.context.moveTo(i, RGraph.GetHeight(this) - this.Get('chart.gutter'));
                this.context.lineTo(i, (RGraph.GetHeight(this) - this.Get('chart.gutter')) + 4);
            this.context.closePath();
        ...
        for (i=0; i<this.left.length; ++i) {
            ...
            */
            ...
            this.context.beginPath();
                ...
                */
                var width = ( (this.left[i] / this.max) * ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter')) ) / 2) );
                var coords = [
                              this.axisWidth - this.Get('chart.gutter.center') - width,
                              this.Get('chart.margin') + (i * ( (RGraph.GetHeight(this) - (2 * this.Get('chart.gutter')) ) / this.left.length)) + this.Get('chart.gutter'),
                              width,
                              this.barHeight
                             ];
    ...
    RGraph.Bipolar.prototype.DrawRightBars = function ()
    {
        ...
        */
        ...
        for (var i=0; i<this.right.length; ++i) {
            ...
            var width = ( (this.right[i] / this.max) * ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter')) ) / 2) );
            var coords = [
                          this.axisWidth,
                          this.Get('chart.margin') + (i * ((RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'))) / this.right.length)) + this.Get('chart.gutter'),
                          width,
                          this.barHeight
                        ];
    ...
    */
    RGraph.Bipolar.prototype.DrawLabels = function ()
    {
        ...
        for (i=0; i<max; ++i) {
            var barAreaHeight = RGraph.GetHeight(this) - (2 * this.Get('chart.gutter'));
        ...
        RGraph.Text(this.context, font, size, this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14, RGraph.number_format(this, this.scale[4], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (1/5), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14, RGraph.number_format(this, this.scale[3], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (2/5), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14, RGraph.number_format(this, this.scale[2], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (3/5), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14, RGraph.number_format(this, this.scale[1], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (4/5), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14, RGraph.number_format(this, this.scale[0], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');

        // Now draw the X labels for the right hand side
        RGraph.Text(this.context, font, size, RGraph.GetWidth(this) - this.Get('chart.gutter'), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14, RGraph.number_format(this, this.scale[4], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, RGraph.GetWidth(this) - (this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (1/5)), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14,RGraph.number_format(this, this.scale[3], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, RGraph.GetWidth(this) - (this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (2/5)), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14,RGraph.number_format(this, this.scale[2], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, RGraph.GetWidth(this) - (this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (3/5)), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14,RGraph.number_format(this, this.scale[1], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
        RGraph.Text(this.context, font, size, RGraph.GetWidth(this) - (this.Get('chart.gutter') + ((RGraph.GetWidth(this) - this.Get('chart.gutter.center') - (2 * this.Get('chart.gutter'))) / 2) * (4/5)), RGraph.GetHeight(this) - this.Get('chart.gutter') + 14,RGraph.number_format(this, this.scale[0], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
    }
    ...
    */
    RGraph.Bipolar.prototype.DrawTitles = function ()
    {
        ...
        RGraph.Text(this.context,this.Get('chart.text.font'), this.Get('chart.text.size'), RGraph.GetWidth(this) - 30, (this.Get('chart.gutter') / 2) + 5, String(this.Get('chart.title.right')), 'center', 'right');
