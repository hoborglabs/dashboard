    ...
    */
    RGraph.Meter.prototype.Draw = function ()
    {
        ...
        */
        ...
        this.centery = RGraph.GetHeight(this) - this.gutter;
        this.radius  = Math.min(RGraph.GetWidth(this) - (2 * this.gutter), RGraph.GetHeight(this) - (2 * this.gutter));
        ...
        */
        if (document.all) {
            ...
            this.context.moveTo(this.gutter, RGraph.GetHeight(this) - this.gutter);
            this.context.fillStyle = 'white';
            this.context.fillRect(this.centerx - this.radius - 5, RGraph.GetHeight(this) - this.gutter + 1, 10, this.gutter);
            this.context.fill();

            // Cover the right tail
            this.context.beginPath();
            this.context.moveTo(RGraph.GetWidth(this) - this.gutter, RGraph.GetHeight(this) - this.gutter);
            this.context.fillStyle = 'white';
            this.context.fillRect(this.centerx + this.radius - 5, RGraph.GetHeight(this) - this.gutter + 1, 10, this.gutter);
            this.context.fill();
        }
    ...
    */
    RGraph.Meter.prototype.DrawLabels = function ()
    {
        ...
        RGraph.Text(context,text_font,text_size,centerx - (Math.cos(0.62819 / 2) * (radius - (0.075 * radius)) ),centery - (Math.sin(0.682819 / 2) * (radius - (0.1587 * radius)) ),units_pre + (((max - min) * (1/10)) + min) + units_post,'center','center', false, 288);
        RGraph.Text(context,text_font,text_size,centerx - (Math.cos(0.62819) * (radius - (0.07 * radius)) ),centery - (Math.sin(0.682819) * (radius - (0.15 * radius)) ),units_pre + (((max - min) * (2/10)) + min) + units_post,'center','center', false, 306);
